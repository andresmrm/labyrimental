...
function(t,e,n){t.exports=!n(24)(function(){return 7!=Object.defineProperty({},"a",{get:function(){return 7}}).a})},/*!***************************************!*\
  ...
  \***************************************/
function(t,e,n){var r=n(5),o=n(8),i=n(6),a=n(9),u=n(39),c="prototype",s=function(t,e,n){var f,l,p,h,y=t&s.F,d=t&s.G,v=t&s.S,g=t&s.P,m=t&s.B,b=d?r:v?r[e]||(r[e]={}):(r[e]||{})[c],w=d?o:o[e]||(o[e]={}),x=w[c]||(w[c]={});d&&(n=e);for(f in n)l=!y&&b&&f in b,p=(l?b:n)[f],h=m&&l?u(p,r):g&&"function"==typeof p?u(Function.call,p):p,b&&!l&&a(b,f,p),w[f]!=p&&i(w,f,h),g&&x[f]!=p&&(x[f]=p)};r.core=o,s.F=1,s.G=2,s.S=4,s.P=8,s.B=16,s.W=32,t.exports=s},/*!**************************************!*\
...
function(t,e,n){"use strict";var r=n(2),o=n(18),i=n(19),a={};n(6)(a,n(4)("iterator"),function(){return this}),t.exports=function(t,e,n){t.prototype=r.create(a,{next:o(1,n)}),i(t,e+" Iterator")}},/*!********************************************!*\
  ...
  \********************************************/
function(t,e,n){"use strict";var r=n(26),o=n(23),i=n(9),a=n(6),u=n(17),c=n(25),s=n(46),f=n(19),l=n(2).getProto,p=n(4)("iterator"),h=!([].keys&&"next"in[].keys()),y="@@iterator",d="keys",v="values",g=function(){return this};t.exports=function(t,e,n,m,b,w,x){s(n,e,m);var S,L,E=function(t){if(!h&&t in _)return _[t];switch(t){case d:return function(){return new n(this,t)};case v:return function(){return new n(this,t)}}return function(){return new n(this,t)}},O=e+" Iterator",j=b==v,k=!1,_=t.prototype,N=_[p]||_[y]||b&&_[b],F=N||E(b);if(N){var P=l(F.call(new t));f(P,O,!0),!r&&u(_,y)&&a(P,p,g),j&&N.name!==v&&(k=!0,F=function(){return N.call(this)})}if(r&&!x||!h&&!k&&_[p]||a(_,p,F),c[e]=F,c[O]=g,b)if(S={values:j?F:E(v),keys:w?F:E(d),entries:j?E("entries"):F},x)for(L in S)L in _||i(_,L,S[L]);else o(o.P+o.F*(h||k),e,S);return S}},/*!******************************************!*\
...
function(t,e,n){"use strict";var r=n(38),o={};o[n(4)("toStringTag")]="z",o+""!="[object z]"&&n(9)(Object.prototype,"toString",function(){return"[object "+r(this)+"]"},!0)},/*!*****************************************!*\
  ...
  \*****************************************/
function(t,e,n){"use strict";var r=n(2),o=n(5),i=n(17),a=n(22),u=n(23),c=n(9),s=n(24),f=n(27),l=n(19),p=n(20),h=n(4),y=n(49),d=n(42),v=n(41),g=n(44),m=n(37),b=n(10),w=n(18),x=r.getDesc,S=r.setDesc,L=r.create,E=d.get,O=o.Symbol,j=o.JSON,k=j&&j.stringify,_=!1,N=h("_hidden"),F=r.isEnum,P=f("symbol-registry"),T=f("symbols"),A="function"==typeof O,C=Object.prototype,R=a&&s(function(){return 7!=L(S({},"a",{get:function(){return S(this,"a",{value:7}).a}})).a})?function(t,e,n){var r=x(C,e);r&&delete C[e],S(t,e,n),r&&t!==C&&S(C,e,r)}:S,M=function(t){var e=T[t]=L(O.prototype);return e._k=t,a&&_&&R(C,t,{configurable:!0,set:function(e){i(this,N)&&i(this[N],t)&&(this[N][t]=!1),R(this,t,w(1,e))}}),e},U=function(t){return"symbol"==typeof t},D=function(t,e,n){return n&&i(T,e)?(n.enumerable?(i(t,N)&&t[N][e]&&(t[N][e]=!1),n=L(n,{enumerable:w(0,!1)})):(i(t,N)||S(t,N,w(1,{})),t[N][e]=!0),R(t,e,n)):S(t,e,n)},B=function(t,e){m(t);for(var n,r=v(e=b(e)),o=0,i=r.length;i>o;)D(t,n=r[o++],e[n]);return t},G=function(t,e){return void 0===e?L(t):B(L(t),e)},J=function(t){var e=F.call(this,t);return e||!i(this,t)||!i(T,t)||i(this,N)&&this[N][t]?e:!0},I=function(t,e){var n=x(t=b(t),e);return!n||!i(T,e)||i(t,N)&&t[N][e]||(n.enumerable=!0),n},K=function(t){for(var e,n=E(b(t)),r=[],o=0;n.length>o;)i(T,e=n[o++])||e==N||r.push(e);return r},z=function(t){for(var e,n=E(b(t)),r=[],o=0;n.length>o;)i(T,e=n[o++])&&r.push(T[e]);return r},W=function(t){if(void 0!==t&&!U(t)){for(var e,n,r=[t],o=1,i=arguments;i.length>o;)r.push(i[o++]);return e=r[1],"function"==typeof e&&(n=e),(n||!g(e))&&(e=function(t,e){return n&&(e=n.call(this,t,e)),U(e)?void 0:e}),r[1]=e,k.apply(j,r)}},Y=s(function(){var t=O();return"[null]"!=k([t])||"{}"!=k({a:t})||"{}"!=k(Object(t))});A||(O=function(){if(U(this))throw TypeError("Symbol is not a constructor");return M(p(arguments.length>0?arguments[0]:void 0))},c(O.prototype,"toString",function(){return this._k}),U=function(t){return t instanceof O},r.create=G,r.isEnum=J,r.getDesc=I,r.setDesc=D,r.setDescs=B,r.getNames=d.get=K,r.getSymbols=z,a&&!n(26)&&c(C,"propertyIsEnumerable",J,!0));var q={"for":function(t){return i(P,t+="")?P[t]:P[t]=O(t)},keyFor:function(t){return y(P,t)},useSetter:function(){_=!0},useSimple:function(){_=!1}};r.each.call("hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","),function(t){var e=h(t);q[t]=A?e:M(e)}),_=!0,u(u.G+u.W,{Symbol:O}),u(u.S,"Symbol",q),u(u.S+u.F*!A,"Object",{create:G,defineProperty:D,defineProperties:B,getOwnPropertyDescriptor:I,getOwnPropertyNames:K,getOwnPropertySymbols:z}),j&&u(u.S+u.F*(!A||Y),"JSON",{stringify:W}),l(O,"Symbol"),l(Math,"Math",!0),l(o.JSON,"JSON",!0)},/*!**************************************************************************!*\
  !*** ./~/css-loader!./~/sass-loader?indentedSyntax!./src/css/style.sass ***!
  \**************************************************************************/
function(t,e,n){e=t.exports=n(54)(),e.push([t.id,"a,body{color:#fff}@font-face{font-family:KlaudiaRegular;src:url("+n(!function(){var t=new Error('Cannot find module "./assets/fonts/Klaudia.ttf"');throw t.code="MODULE_NOT_FOUND",t}())+') format("truetype");font-weight:400;font-style:normal}body{margin:0;background-color:#000;font-family:KlaudiaRegular;font-weight:400;font-style:normal;font-size:18pt;text-shadow:1px 1px 2px #747474}h1{text-shadow:0 0 10px #FFF}#loading-screen{animation:2s appear;text-align:center;padding:30% 0}#loading-screen h2{animation-name:shine;animation-duration:2s;animation-direction:alternate;animation-iteration-count:infinite;animation-timing-function:ease-out}#interface-outer{position:absolute;text-align:center}b{color:#7CB5FF}.page{animation:2s appear}ul{list-style-type:none;padding:0}a{background-color:#4F7BAE;border-radius:4px;display:inline-block;cursor:pointer;padding:9px 32px;text-decoration:none;margin:20px;text-shadow:2px 2px 2px #2A5687;box-shadow:0 0 3px #4f7bae;transition:box-shadow .5s}a:hover{box-shadow:0 0 5px 5px rgba(209,235,255,.5)}a:active{position:relative;color:#aaa;top:1px}@keyframes appear{0%{opacity:0}100%{opacity:1}}@keyframes shine{0%{text-shadow:0 0 0 #FFF}100%{text-shadow:0 0 10px #FFF}}@keyframes slidein{from{margin-left:100%;width:300%}to{margin-left:0;width:100%}}',""])},/*!**************************************!*\
